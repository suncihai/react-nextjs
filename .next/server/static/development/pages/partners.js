...
function (_React$Component) {
  ...
  _createClass(Header, [{
    ...
    value: function logout() {
      ...
      this.props.logout();
      next_router__WEBPACK_IMPORTED_MODULE_12___default.a.replace('/partners');
    }
  }, {
    key: "render",
    value: function render() {
...
function (_React$Component) {
  ...
  _createClass(Partners, [{
    ...
    value: function componentWillUnmount() {
      ...
      subItems.forEach(function (subObj, index) {
...
var Body = styled_components__WEBPACK_IMPORTED_MODULE_3___default.a.div.withConfig({
  displayName: "partners__Body",
  componentId: "sc-1kxgigg-0"
})(["background:#ebeef0;"]);
var Container = styled_components__WEBPACK_IMPORTED_MODULE_3___default.a.div.withConfig({
  displayName: "partners__Container",
  componentId: "sc-1kxgigg-1"
...
/*#__PURE__*/
function (_React$Component) {
  _inherits(PartnersPage, _React$Component);
  ...
  function PartnersPage() {
    ...
    _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(PartnersPage)).call.apply(_getPrototypeOf2, [this].concat(args)));
...
module.exports = __webpack_require__(/*! ./pages/partners.js */"./pages/partners.js");
